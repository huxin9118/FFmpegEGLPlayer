...
#define JAVA_PACKET							com_example_ffmpegsdlplayer_activity
#define JAVA_RENDER(function)            	CONCAT1(JAVA_PACKET, GLRenderer, function)
#define JAVA_CLASS_RENDER     				"com/example/ffmpegsdlplayer/activity/GLRenderer"
...
JNIEXPORT jint JNICALL JAVA_RENDER(nativeInitSDLThread)(JNIEnv* env, jobject obj ,jstring url, jboolean isStreamMedia, jint rotate, jobject surface)
{
	initGlobalState();
...
//------------------------Mediacodec init------------------------		
	...
	mediacodec_decoder_open(mediacodec_decoder,window);
#endif	
//--------------------------render_thread------------------------------
	RenderContext renderContext;
	renderContext.methodID_updateData = methodID_updateData;
