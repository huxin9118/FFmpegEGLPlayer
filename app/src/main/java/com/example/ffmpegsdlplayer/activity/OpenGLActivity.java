...
//        input_url ="/storage/emulated/0/testvideo/cwssm_848x480.yuv";
        ...
        btnCodecType.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showCodecTypeDialog();
//                ViewGroup.LayoutParams ly = mSurfaceViewWrapper.getLayoutParams();
//                if(ly.width == ViewGroup.LayoutParams.MATCH_PARENT && ly.width == ViewGroup.LayoutParams.MATCH_PARENT){
//                    ly.width = mSurfaceViewWrapper.getWidth();
//                    ly.height = mSurfaceViewWrapper.getHeight();
//                }
//                ly.width = ly.width / 3;
//                ly.height = ly.height / 2;
//                mSurfaceViewWrapper.setLayoutParams(ly);
            }
        });
        if(isYUV){
