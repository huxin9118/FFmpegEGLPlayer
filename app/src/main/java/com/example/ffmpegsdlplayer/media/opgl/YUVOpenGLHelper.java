...
public class YUVOpenGLHelper implements OpenGLHelper{
	/**
	 * NO_TEXTURE
	 */
...
//	 "gl_FragColor = ss;\n}";
	 ...
	 */
	private int mUsedTextYId = YUVOpenGLHelper.NO_TEXTURE;
	/**
	 * OpenGL User text U id
	 */
	private int mUsedTextUId = YUVOpenGLHelper.NO_TEXTURE;
	/**
	 * OpenGL User text V id
	 */
	private int mUsedTextVId = YUVOpenGLHelper.NO_TEXTURE;
	...
	public void onDrawFrame(Object data) {
		...
		mUsedTextYId = YUVOpenGLHelper.loadTexture(yByteBuffer, (int) mImageWidth, (int) mImageHeight, mUsedTextYId);

		checkGlError("onDrawFrame Y");

		mUsedTextUId = YUVOpenGLHelper.loadTexture(uByteBuffer, ((int) mImageWidth) / 2, ((int) mImageHeight) / 2,
				mUsedTextUId);

		checkGlError("onDrawFrame U");

		mUsedTextVId = YUVOpenGLHelper.loadTexture(vByteBuffer, ((int) mImageWidth) / 2, ((int) mImageHeight) / 2,
				mUsedTextVId);
